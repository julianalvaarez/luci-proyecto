        ...
        <div className="space-y-8">
            ...
            {state.isFirstTime && (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white p-8 md:p-10 rounded-[40px] shadow-[0_4px_30px_rgb(0,0,0,0.03)] border border-gray-100">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-gray-700">Actividad Física</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-gray-700">Enfermedades Diagnosticadas</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-gray-700">Medicamentos</label>
                    ...
                    <div className="space-y-3">
                        <label className="text-sm font-bold text-gray-700">¿Consultaste previamente con un nutricionista?</label>
            ...
            {state.isFirstTime === false && (
                <div className="bg-white p-10 rounded-[40px] shadow-[0_4px_30px_rgb(0,0,0,0.03)] border border-gray-100 text-center space-y-6">
                    <div className="bg-emerald-50 h-16 w-16 rounded-full flex items-center justify-center mx-auto">
                        <CheckCircle className="h-8 w-8 text-brand-primary" />
                    </div>
                    <div>
                        <h3 className="text-xl font-bold">¡Hola de nuevo!</h3>
                        <p className="text-gray-500 mt-2">Como ya nos conocemos, pasaremos directamente a agendar tu próximo control.</p>
                    </div>
                    <button
                        onClick={() => setStep('slots')}
                        className="w-full h-14 bg-brand-primary text-white rounded-full font-bold hover:bg-brand-secondary transition-all hover:scale-[1.02] active:scale-95 shadow-lg shadow-emerald-100"
                    >
